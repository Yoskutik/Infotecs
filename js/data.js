...
/**
 * Этот модуль просто хранит в себе моковые данные.
 * Подразумевается, что в реальном приложении данные
 * приходят через AJAX запрос к API.
 */
(() => {
    /**
     * @type {Array<{id: string, name: {firstName: string, lastName: string}, phone: string, about: string, eyeColor: string}>}
     */
    window.data = [
        {
